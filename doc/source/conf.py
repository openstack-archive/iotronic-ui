...
repository_name = 'openstack/iotronic_ui'
bug_project = 'None'
bug_tag = ''
...
htmlhelp_basename = 'iotronic_uidoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'iotronic_ui.tex',
     u'IoTronic Panels Documentation',
...
man_pages = [
    ('index', u'IoTronic Panels Documentation',
     'Documentation for the IoTronic Panels plugin to the Openstack\
      Dashboard (Horizon)',
     [u'OpenStack'], 1)
]
...
texinfo_documents = [
    ('index', 'IoTronic Panels',
     u'IoTronic Panels Documentation', u'OpenStack',
     'IoTronic Panels',
     'Iotronic plugin for the OpenStack Dashboard', 'Miscellaneous'),
]
